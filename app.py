...
from schemas.schemas import PlanResult , Plan , Response
...
@app.get("/chat") 
def generate_plan(message : str) -> Response : 
    return Response(type="PLAN" , content=plan(message))


@app.post("/executePlan")
def execute_plan_route(plan : Plan) -> Response :
    return Response(type="PLAN_RESULT" , content=execute_plan_in_sandbox(plan))
